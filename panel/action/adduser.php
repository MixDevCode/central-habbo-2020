...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		$sqlsdsd = "INSERT INTO users (user, password)".
				"VALUES ('$name2', '$pass')";
		$result = $link->query($sqlsdsd);
		
		$sqldsd = "INSERT INTO logs (user, action, timestamp)".
			"VALUES ('$nombreu', 'Agregó el usuario $name2 a la lista', '$timestamp')";
		$link->query($sqldsd);
						...
						<div class="col-md-12">
							<form role="form" method="post" action="" enctype="multipart/form-data">
								<div class="form-group">
									<label>Nombre</label>
									<input class="form-control" name="user" placeholder="Ej: Mix">
								</div>
								<div class="form-group">
