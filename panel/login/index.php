		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input <?php echo (!empty($username_err)) ? 'alert-validate' : ''; ?>" data-validate = "<?php echo $username_err; ?>">
					...
					<div class="wrap-input100 validate-input <?php echo (!empty($password_err)) ? 'alert-validate' : ''; ?>" data-validate="<?php echo $password_err; ?>">
